...
INSERT INTO "water"."scheduler" (task_id, task_type, licence_ref, task_config, next_run, date_created)
  VALUES(300, 'updateNotificationEvents', '-', '{"count":"30","period":"second"}', NOW(), NOW())
