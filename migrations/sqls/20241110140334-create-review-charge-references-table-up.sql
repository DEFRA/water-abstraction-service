...
CREATE TABLE water.review_charge_references (
	...
	charge_reference_id uuid NULL,
	"aggregate" numeric DEFAULT '1'::numeric NULL,
	amended_aggregate numeric DEFAULT '1'::numeric NULL,
	charge_adjustment numeric DEFAULT '1'::numeric NULL,
	amended_charge_adjustment numeric DEFAULT '1'::numeric NULL,
	abatement_agreement numeric DEFAULT '1'::numeric NULL,
	...
	authorised_volume numeric DEFAULT '0'::numeric NULL,
	amended_authorised_volume numeric DEFAULT '0'::numeric NULL,
