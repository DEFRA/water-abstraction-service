...
experiment('modules/billing/services/billing-volumes-service', () => {
  beforeEach(async () => {
    ...
    sandbox.stub(billingVolumesRepo, 'findApprovedByChargeElementIdsFinancialYearAndBatchId').resolves([]);
  ...
  experiment('.getVolumesForChargeElements', () => {
    ...
    test('calls volumes repo findApprovedByChargeElementIdsFinancialYearAndBatchId', () => {
      expect(billingVolumesRepo.findApprovedByChargeElementIdsFinancialYearAndBatchId.called).to.be.true();
    });

    test('calls with the right params', () => {
      const params = billingVolumesRepo.findApprovedByChargeElementIdsFinancialYearAndBatchId.lastCall.args;
