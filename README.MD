...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_water-abstraction-service&metric=alert_status)](https://sonarcloud.io/dashboard?id=DEFRA_water-abstraction-service)
