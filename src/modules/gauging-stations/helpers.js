...
is equal to or greater than ${data.hol_rate_level}${data.hol_rate_level_unit}.`;
 ...
 ${data.purpose_type === 'Abstraction' ? 'abstraction' : activity} shall not cause the ${data.hof_type === 'Hands off flow' ? `flow immediately downstream of the said ${abstractionPoint} 
