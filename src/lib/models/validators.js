...
const assertAuthorisedDays = value => assert(value, VALID_POSITIVE_INTEGER.max(366).allow(null));
const assertBillableDays = value => assert(value, VALID_INTEGER.min(0).max(366).allow(null));
