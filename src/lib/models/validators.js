...
const assertFactorWithPrefix = value => assert(value, VALID_FACTOR_WITH_PREFIX);
const assertNumeric = value => assert(value, Joi.number().allow(0).allow(null));
...
exports.assertFactorWithPrefix = assertFactorWithPrefix;
