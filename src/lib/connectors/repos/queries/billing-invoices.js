...
values (:invoiceAccountId, :address, :invoiceAccountNumber, NOW(), NOW(), :billingBatchId, :financialYearEnding) on conflict (invoice_account_id, billing_batch_id, financial_year_ending) do update 
