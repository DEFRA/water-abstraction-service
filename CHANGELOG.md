...
#### [v3.17.16](https://github.com/DEFRA/water-abstraction-service/compare/v3.18.0...v3.17.16)

- Bump joi from 17.13.6 to 17.13.7 [`#2855`](https://github.com/DEFRA/water-abstraction-service/pull/2855)
- Bump js-yaml from 4.3.1 to 4.3.2 [`#2854`](https://github.com/DEFRA/water-abstraction-service/pull/2854)
- Update `licence_gauging_stations` `date_updated` [`#2853`](https://github.com/DEFRA/water-abstraction-service/pull/2853)
- Data fix for deleted licence - part 1 Chg version [`#2850`](https://github.com/DEFRA/water-abstraction-service/pull/2850)
- Bump browserslist from 4.28.2 to 4.28.8 [`#2851`](https://github.com/DEFRA/water-abstraction-service/pull/2851)
- Bump joi from 17.13.4 to 17.13.6 [`#2849`](https://github.com/DEFRA/water-abstraction-service/pull/2849)
- Use internal copy of return ID regex instead of water-abstraction-helpers [`#2848`](https://github.com/DEFRA/water-abstraction-service/pull/2848)
- Bump vm2 from 3.11.5 to 3.11.6 [`#2847`](https://github.com/DEFRA/water-abstraction-service/pull/2847)
- Bump pg from 8.21.0 to 8.23.0 [`#2846`](https://github.com/DEFRA/water-abstraction-service/pull/2846)
- Bump csv-stringify from 6.8.2 to 6.8.3 [`#2845`](https://github.com/DEFRA/water-abstraction-service/pull/2845)
- Bump js-yaml from 4.3.0 to 4.3.1 [`#2844`](https://github.com/DEFRA/water-abstraction-service/pull/2844)
- Bump csv-stringify from 6.8.1 to 6.8.2 [`#2843`](https://github.com/DEFRA/water-abstraction-service/pull/2843)
- Bump @hapi/hapi from 21.4.9 to 21.4.10 [`#2842`](https://github.com/DEFRA/water-abstraction-service/pull/2842)
- Bump brace-expansion from 1.1.16 to 1.1.18 [`#2841`](https://github.com/DEFRA/water-abstraction-service/pull/2841)
- Amend delete 'changed' imported ret. req purposes [`#2840`](https://github.com/DEFRA/water-abstraction-service/pull/2840)
- Delete 'changed' imported ret. req. purposes [`#2839`](https://github.com/DEFRA/water-abstraction-service/pull/2839)
- Bump js-yaml from 4.2.0 to 4.3.0 [`#2838`](https://github.com/DEFRA/water-abstraction-service/pull/2838)
- Bump brace-expansion from 1.1.13 to 1.1.16 [`#2837`](https://github.com/DEFRA/water-abstraction-service/pull/2837)
- Bump actions/checkout from 7.0.0 to 7.0.1 [`#2836`](https://github.com/DEFRA/water-abstraction-service/pull/2836)
- Bump sonarsource/sonarqube-scan-action from 8.2.0 to 8.2.1 [`#2834`](https://github.com/DEFRA/water-abstraction-service/pull/2834)
- Bump actions/setup-node from 6.4.0 to 7.0.0 [`#2835`](https://github.com/DEFRA/water-abstraction-service/pull/2835)
- Bump csv-stringify from 6.8.0 to 6.8.1 [`#2833`](https://github.com/DEFRA/water-abstraction-service/pull/2833)
- Migration fix for notifications with no msg type [`#2832`](https://github.com/DEFRA/water-abstraction-service/pull/2832)
- Update unregister licence recording - Migrate data [`#2831`](https://github.com/DEFRA/water-abstraction-service/pull/2831)
- Bump actions/cache from 5.0.5 to 6.1.0 [`#2830`](https://github.com/DEFRA/water-abstraction-service/pull/2830)
- Update unregister licence recording - Create table [`#2829`](https://github.com/DEFRA/water-abstraction-service/pull/2829)
- Upgrade Node to version 24 [`#2828`](https://github.com/DEFRA/water-abstraction-service/pull/2828)
- Stop using NALD returns data in legacy service [`#2827`](https://github.com/DEFRA/water-abstraction-service/pull/2827)
- Fix dependency issue following Node 24 upgrade [`#2826`](https://github.com/DEFRA/water-abstraction-service/pull/2826)
- Add cooldown option to dependabot workflow [`#2825`](https://github.com/DEFRA/water-abstraction-service/pull/2825)
- Add an npmrc [`#2824`](https://github.com/DEFRA/water-abstraction-service/pull/2824)
- Bump actions/checkout from 6.0.3 to 7.0.0 [`#2822`](https://github.com/DEFRA/water-abstraction-service/pull/2822)
- Add GitHub action dependency-review-action to our CI [`#2821`](https://github.com/DEFRA/water-abstraction-service/pull/2821)
- Data fix for invalid start date in ret. req. record [`#2819`](https://github.com/DEFRA/water-abstraction-service/pull/2819)
- Bump @babel/core from 7.20.2 to 7.29.7 [`#2818`](https://github.com/DEFRA/water-abstraction-service/pull/2818)
- Bump js-yaml from 4.1.1 to 4.2.0 [`#2817`](https://github.com/DEFRA/water-abstraction-service/pull/2817)
- Pin GitHub actions to commit SHAs instead of versions [`#2816`](https://github.com/DEFRA/water-abstraction-service/pull/2816)
- Bump csv-stringify from 6.7.0 to 6.8.0 [`#2815`](https://github.com/DEFRA/water-abstraction-service/pull/2815)
- Bump joi from 17.13.3 to 17.13.4 [`#2814`](https://github.com/DEFRA/water-abstraction-service/pull/2814)
- Bump @hapi/wreck from 18.1.1 to 18.1.2 [`#2813`](https://github.com/DEFRA/water-abstraction-service/pull/2813)
- Migrate `new_internal_user_email` status checks to system [`#2812`](https://github.com/DEFRA/water-abstraction-service/pull/2812)
- Bump ioredis from 5.11.0 to 5.11.1 [`#2811`](https://github.com/DEFRA/water-abstraction-service/pull/2811)
- Add missed rtn invite alternate due dates [`#2810`](https://github.com/DEFRA/water-abstraction-service/pull/2810)
- Bump vm2 from 3.11.3 to 3.11.5 [`#2809`](https://github.com/DEFRA/water-abstraction-service/pull/2809)
- Bump ioredis from 5.10.1 to 5.11.0 [`#2808`](https://github.com/DEFRA/water-abstraction-service/pull/2808)
- Bump pg from 8.20.0 to 8.21.0 [`#2807`](https://github.com/DEFRA/water-abstraction-service/pull/2807)
- Bump vm2 from 3.11.2 to 3.11.3 [`#2805`](https://github.com/DEFRA/water-abstraction-service/pull/2805)
- fix: support updated communication fields [`#2803`](https://github.com/DEFRA/water-abstraction-service/pull/2803)
- Bump @hapi/hapi from 21.4.8 to 21.4.9 [`#2802`](https://github.com/DEFRA/water-abstraction-service/pull/2802)
- Bump vm2 from 3.10.3 to 3.11.2 [`#2801`](https://github.com/DEFRA/water-abstraction-service/pull/2801)
- Bump @hapi/hapi from 21.4.7 to 21.4.8 [`#2800`](https://github.com/DEFRA/water-abstraction-service/pull/2800)
- Bump lodash from 4.17.23 to 4.18.1 [`#2799`](https://github.com/DEFRA/water-abstraction-service/pull/2799)
- Bump brace-expansion from 1.1.12 to 1.1.13 [`#2798`](https://github.com/DEFRA/water-abstraction-service/pull/2798)
- Bump handlebars from 4.7.7 to 4.7.9 [`#2797`](https://github.com/DEFRA/water-abstraction-service/pull/2797)
- Bump picomatch from 2.3.1 to 2.3.2 [`#2796`](https://github.com/DEFRA/water-abstraction-service/pull/2796)
- Add address_id field to licence versions table [`#2794`](https://github.com/DEFRA/water-abstraction-service/pull/2794)
- Add abs period data to all `licence_gauging_stations` records [`#2793`](https://github.com/DEFRA/water-abstraction-service/pull/2793)
- Bump ioredis from 5.10.0 to 5.10.1 [`#2792`](https://github.com/DEFRA/water-abstraction-service/pull/2792)
- Bump flatted from 3.2.7 to 3.4.2 [`#2791`](https://github.com/DEFRA/water-abstraction-service/pull/2791)
- Bump csv-stringify from 6.6.0 to 6.7.0 [`#2790`](https://github.com/DEFRA/water-abstraction-service/pull/2790)
- Add company_id field to licence versions table [`#2789`](https://github.com/DEFRA/water-abstraction-service/pull/2789)
- Bump @hapi/hapi from 21.4.6 to 21.4.7 [`#2788`](https://github.com/DEFRA/water-abstraction-service/pull/2788)
- Bump pg from 8.19.0 to 8.20.0 [`#2787`](https://github.com/DEFRA/water-abstraction-service/pull/2787)
- Bump underscore from 1.13.6 to 1.13.8 [`#2786`](https://github.com/DEFRA/water-abstraction-service/pull/2786)
- Bump ioredis from 5.9.3 to 5.10.0 [`#2785`](https://github.com/DEFRA/water-abstraction-service/pull/2785)
- Fix link to licence summary from verification codes [`#2784`](https://github.com/DEFRA/water-abstraction-service/pull/2784)
- Bump pg from 8.18.0 to 8.19.0 [`#2783`](https://github.com/DEFRA/water-abstraction-service/pull/2783)
- Bump ajv from 6.12.6 to 6.14.0 [`#2782`](https://github.com/DEFRA/water-abstraction-service/pull/2782)
- Bump @hapi/hapi from 21.4.4 to 21.4.6 [`#2781`](https://github.com/DEFRA/water-abstraction-service/pull/2781)
- Add new 7** purposes to service [`#2779`](https://github.com/DEFRA/water-abstraction-service/pull/2779)
- Bump ioredis from 5.9.2 to 5.9.3 [`#2778`](https://github.com/DEFRA/water-abstraction-service/pull/2778)
- Add additional columns to licence ver. holders table [`#2777`](https://github.com/DEFRA/water-abstraction-service/pull/2777)
- Remove review return due date NOT NULL constraint [`#2776`](https://github.com/DEFRA/water-abstraction-service/pull/2776)
- Bump pg from 8.17.2 to 8.18.0 [`#2775`](https://github.com/DEFRA/water-abstraction-service/pull/2775)
- Amend reasons for new charge versions [`#2774`](https://github.com/DEFRA/water-abstraction-service/pull/2774)
- Bump vm2 from 3.10.0 to 3.10.3 [`#2773`](https://github.com/DEFRA/water-abstraction-service/pull/2773)
- Bump lodash from 4.17.21 to 4.17.23 [`#2772`](https://github.com/DEFRA/water-abstraction-service/pull/2772)
- Bump pg from 8.17.1 to 8.17.2 [`#2771`](https://github.com/DEFRA/water-abstraction-service/pull/2771)
- Bump pg from 8.17.0 to 8.17.1 [`#2769`](https://github.com/DEFRA/water-abstraction-service/pull/2769)
- Bump ioredis from 5.9.1 to 5.9.2 [`#2768`](https://github.com/DEFRA/water-abstraction-service/pull/2768)
- Remove presroc supp. billing flag migration, again [`#2770`](https://github.com/DEFRA/water-abstraction-service/pull/2770)
- Amend migration 2 add return_log_id to review rtns [`#2767`](https://github.com/DEFRA/water-abstraction-service/pull/2767)
- Bump pg from 8.16.3 to 8.17.0 [`#2766`](https://github.com/DEFRA/water-abstraction-service/pull/2766)
- Add `return_log_id` to `review_returns` table [`#2765`](https://github.com/DEFRA/water-abstraction-service/pull/2765)
- Remove auto-merge from our GitHub workflows [`#2764`](https://github.com/DEFRA/water-abstraction-service/pull/2764)
- Update returns mapping to handle WRLS return logs [`#2763`](https://github.com/DEFRA/water-abstraction-service/pull/2763)
- Bump ioredis from 5.9.0 to 5.9.1 [`#2762`](https://github.com/DEFRA/water-abstraction-service/pull/2762)
- Create licence version holders table [`#2759`](https://github.com/DEFRA/water-abstraction-service/pull/2759)
- Bump vm2 from 3.9.19 to 3.10.0 [`#2761`](https://github.com/DEFRA/water-abstraction-service/pull/2761)
- Bump ioredis from 5.8.2 to 5.9.0 [`#2760`](https://github.com/DEFRA/water-abstraction-service/pull/2760)
- Delete legacy abstraction alert notifications [`#2758`](https://github.com/DEFRA/water-abstraction-service/pull/2758)
- Update message_refs in scheduled_notification_categories [`#2757`](https://github.com/DEFRA/water-abstraction-service/pull/2757)
- Bump actions/cache from 4 to 5 [`#2756`](https://github.com/DEFRA/water-abstraction-service/pull/2756)
- Migration to add `issue_date` and `application_number` [`#2755`](https://github.com/DEFRA/water-abstraction-service/pull/2755)

#### [v3.18.0](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.15...v3.18.0)

> 10 December 2025

#### [v3.17.15](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.14...v3.17.15)
...
#### [v3.17.14](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.13...v3.17.14)
...
#### [v3.17.13](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.12...v3.17.13)
...
#### [v3.17.12](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.11...v3.17.12)
...
#### [v3.17.11](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.10...v3.17.11)
...
#### [v3.17.10](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.9...v3.17.10)
...
#### [v3.17.9](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.8...v3.17.9)
...
#### [v3.17.8](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.7...v3.17.8)
...
#### [v3.17.7](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.6...v3.17.7)
...
#### [v3.17.6](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.5...v3.17.6)
...
#### [v3.17.5](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.4...v3.17.5)
...
#### [v3.17.4](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.3...v3.17.4)
...
#### [v3.17.3](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.2...v3.17.3)

> 16 January 2026

- Remove presroc supp. billing flag migration, again [`#2770`](https://github.com/DEFRA/water-abstraction-service/pull/2770)

#### [v3.17.2](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.1...v3.17.2)
...
#### [v3.17.1](https://github.com/DEFRA/water-abstraction-service/compare/v3.17.0...v3.17.1)
...
#### [v3.17.0](https://github.com/DEFRA/water-abstraction-service/compare/v3.16.7...v3.17.0)

> 10 December 2025

- Fix missing communication sent date in external UI [`#2754`](https://github.com/DEFRA/water-abstraction-service/pull/2754)
- Migration to change failed rtn invite message_ref [`#2753`](https://github.com/DEFRA/water-abstraction-service/pull/2753)
- Bump aws-sdk from 2.1692.0 to 2.1693.0 [`#2752`](https://github.com/DEFRA/water-abstraction-service/pull/2752)
- Record contact and notice type in notifications [`#2751`](https://github.com/DEFRA/water-abstraction-service/pull/2751)
- Bump jws from 3.2.2 to 3.2.3 [`#2750`](https://github.com/DEFRA/water-abstraction-service/pull/2750)
- Soft delete workflow record [`#2749`](https://github.com/DEFRA/water-abstraction-service/pull/2749)
- Add permissions to scanner workflow [`#2748`](https://github.com/DEFRA/water-abstraction-service/pull/2748)
- Add shai-hulud-detect as a daily workflow [`#2747`](https://github.com/DEFRA/water-abstraction-service/pull/2747)
- Bump actions/checkout from 5 to 6 [`#2746`](https://github.com/DEFRA/water-abstraction-service/pull/2746)
- Migration to enhance dynamic due date support [`#2741`](https://github.com/DEFRA/water-abstraction-service/pull/2741)
- Stop interferring with notices & notifications [`#2745`](https://github.com/DEFRA/water-abstraction-service/pull/2745)
- Bump js-yaml from 4.1.0 to 4.1.1 [`#2744`](https://github.com/DEFRA/water-abstraction-service/pull/2744)
